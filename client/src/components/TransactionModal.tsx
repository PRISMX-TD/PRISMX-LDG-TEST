      ...
      <DialogContent className="sm:max-w-md p-0 overflow-hidden flex flex-col h-[90vh] sm:h-auto [&>button]:top-4 [&>button]:right-4 [&>button]:h-8 [&>button]:w-8" data-testid="modal-transaction" aria-describedby={undefined}>
        ...
        <div className="flex-1 overflow-y-auto px-4 py-4 space-y-5">
          <Tabs
            ...
            className="w-full"
          >
            <TabsList className="grid w-full grid-cols-3 bg-white/[0.04] border border-white/[0.08] p-1 rounded-full" data-testid="tabs-transaction-type">
              <TabsTrigger value="expense" className="rounded-full data-[state=active]:bg-gradient-to-br data-[state=active]:from-rose-400 data-[state=active]:to-rose-600 data-[state=active]:text-white data-[state=active]:shadow-[0_4px_12px_-4px_rgba(244,114,128,0.5)] text-foreground/55" data-testid="tab-expense">
                支出
              </TabsTrigger>
              <TabsTrigger value="income" className="rounded-full data-[state=active]:bg-gradient-to-br data-[state=active]:from-emerald-400 data-[state=active]:to-emerald-600 data-[state=active]:text-white data-[state=active]:shadow-[0_4px_12px_-4px_rgba(52,211,153,0.5)] text-foreground/55" data-testid="tab-income">
                收入
              </TabsTrigger>
              <TabsTrigger value="transfer" className="rounded-full data-[state=active]:bg-gradient-to-br data-[state=active]:from-[#a78bfa] data-[state=active]:to-[#7c3aed] data-[state=active]:text-white data-[state=active]:shadow-[0_4px_12px_-4px_rgba(124,58,237,0.5)] text-foreground/55" data-testid="tab-transfer">
                转账
              </TabsTrigger>
            </TabsList>
          </Tabs>
          ...
          <Form {...form}>
            <form id="transaction-form" onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
              ...
              {/* 金额巨大化显示区 */}
              <div className="flex flex-col items-center justify-center py-5 sm:py-4 rounded-3xl border border-white/[0.06]" style={{ background: "linear-gradient(135deg, rgba(167,139,250,0.10) 0%, rgba(99,102,241,0.05) 100%), rgba(20,12,32,0.6)" }}>
              ...
              {isMobile && (
                <div className="grid grid-cols-4 gap-2">
                  {[
                    { label: "AC", value: "AC", className: "bg-rose-500/15 text-rose-300 border border-rose-500/20" },
                    { label: "⌫", value: "⌫", className: "bg-white/[0.06] text-foreground/65 border border-white/[0.08]" },
                    { label: "÷", value: "/", className: "bg-[#a78bfa]/15 text-[#a78bfa] border border-[#a78bfa]/20" },
                    { label: "×", value: "*", className: "bg-[#a78bfa]/15 text-[#a78bfa] border border-[#a78bfa]/20" },
                    { label: "7", value: "7", className: "bg-white/[0.04] text-foreground border border-white/[0.06] hover:bg-white/[0.08]" },
                    { label: "8", value: "8", className: "bg-white/[0.04] text-foreground border border-white/[0.06] hover:bg-white/[0.08]" },
                    { label: "9", value: "9", className: "bg-white/[0.04] text-foreground border border-white/[0.06] hover:bg-white/[0.08]" },
                    { label: "-", value: "-", className: "bg-[#a78bfa]/15 text-[#a78bfa] border border-[#a78bfa]/20" },
                    { label: "4", value: "4", className: "bg-white/[0.04] text-foreground border border-white/[0.06] hover:bg-white/[0.08]" },
                    { label: "5", value: "5", className: "bg-white/[0.04] text-foreground border border-white/[0.06] hover:bg-white/[0.08]" },
                    { label: "6", value: "6", className: "bg-white/[0.04] text-foreground border border-white/[0.06] hover:bg-white/[0.08]" },
                    { label: "+", value: "+", className: "bg-[#a78bfa]/15 text-[#a78bfa] border border-[#a78bfa]/20" },
                    { label: "1", value: "1", className: "bg-white/[0.04] text-foreground border border-white/[0.06] hover:bg-white/[0.08]" },
                    { label: "2", value: "2", className: "bg-white/[0.04] text-foreground border border-white/[0.06] hover:bg-white/[0.08]" },
                    { label: "3", value: "3", className: "bg-white/[0.04] text-foreground border border-white/[0.06] hover:bg-white/[0.08]" },
                    { label: "=", value: "=", className: "bg-gradient-to-br from-[#a78bfa] to-[#7c3aed] text-white border-0 shadow-[0_4px_12px_-4px_rgba(124,58,237,0.5)]" },
                    { label: "0", value: "0", className: "bg-white/5 text-foreground col-span-2" },
                    { label: ".", value: ".", className: "bg-white/[0.04] text-foreground border border-white/[0.06] hover:bg-white/[0.08]" },
                  ].map((key) => (
                    <Button
              ...
              {/* 汇率转换区 (仅当币种不同时显示) */}
              {needsCurrencyConversion && (
                <div className="p-3 rounded-2xl space-y-3 bg-amber-400/8 border border-amber-400/20">
                  <div className="flex items-center justify-between">
