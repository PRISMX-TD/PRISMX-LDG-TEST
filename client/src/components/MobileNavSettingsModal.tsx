...
// FIX: this list was missing loans / sub-ledgers / split, so users couldn't
// add/remove those entries via this settings dialog despite them appearing in
// the bottom-bar nav. Aligned with the master list in MobileNavBar.tsx.
const allNavItems: NavItem[] = [
  ...
  { key: "loans", label: "借贷", icon: HandCoins, defaultMain: false },
  { key: "sub-ledgers", label: "子账本", icon: BookOpen, defaultMain: false },
  { key: "split", label: "费用分摊", icon: Users, defaultMain: false },
