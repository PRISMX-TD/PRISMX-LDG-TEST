...
RESEND_API_KEY=re_Eb5FQMRT_P4g3Yb5e7g2ayGMpXjDbMtVH
RESEND_FROM=noreply@你的已验证域名  const [resetUrl, setResetUrl] = useState<string | null>(null);
              ...
              <div className="space-y-3 text-sm">
                ...
                {resetUrl && (
                  <div className="rounded-xl p-3 bg-amber-400/10 border border-amber-400/20">
                    <p className="text-[11px] text-amber-300 mb-1">点击下方链接重置密码（1小时内有效）：</p>
