      ...
      <div className="space-y-4 md:space-y-6 max-w-7xl mx-auto">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-2xl font-semibold flex items-center gap-2 text-white">
            <HandCoins className="w-6 h-6 text-neon-purple" />
            借贷管理
          </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-center justify-between">
          ...
          <div className="w-full sm:w-auto text-xs text-muted-foreground">按状态筛选借贷记录</div>
        </div>
...
function LoanCard({ loan }: { loan: Loan }) {
  ...
  return (
    <Card className={cn(
      "glass-card border-primary/20 relative overflow-hidden transition-all hover:shadow-md",
