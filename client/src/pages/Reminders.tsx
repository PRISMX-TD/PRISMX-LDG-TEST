              ...
              <div className="space-y-3">
                {unpaidReminders
                  ...
                  .map((reminder) => {
                    ...
                    return (
                      <Card key={reminder.id} className={`glass-card border-primary/20 ${status.urgent ? "border-expense/50" : ""}`}>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                {paidReminders.slice(0, 5).map((reminder) => (
                  <Card key={reminder.id} className="glass-card border-primary/20 bg-muted/30">
                    <CardContent className="flex items-center justify-between p-4">
                      <div className="flex items-center gap-4">
