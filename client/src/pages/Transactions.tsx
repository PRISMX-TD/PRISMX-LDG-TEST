    ...
    <PageContainer scrollable={false}>
      <div className="flex-1 flex flex-col min-h-0 space-y-4 md:space-y-6">
        ...
        <div className="grid gap-3 md:gap-4 grid-cols-3">
          <div className="glass-card p-3 md:p-4 group min-h-[104px]">
            ...
            {isStatsLoading ? (
              ...
              <p className="text-base md:text-xl font-semibold font-mono text-white group-hover:text-cyan-100 transition-colors">
          ...
          <div className="glass-card p-3 md:p-4 group min-h-[104px]">
            ...
            {isStatsLoading ? (
              ...
              <p className="text-base md:text-xl font-semibold font-mono text-white group-hover:text-red-200 transition-colors">
