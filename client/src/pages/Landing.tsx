      ...
      <main className="relative">
        ...
        <section className="pt-20 md:pt-32 pb-16 md:pb-24 px-4 sm:px-6">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <h1 className="text-[42px] sm:text-[58px] md:text-[78px] font-bold tracking-tight leading-[1.05] mb-6">
            ...
            <p className="text-[16px] md:text-[18px] text-foreground/65 max-w-2xl mx-auto mb-10 leading-relaxed">
