...
function AuthenticatedLayout() {
  ...
  return (
    <>
      {/* Desktop Layout */}
      <div className="hidden md:block h-screen overflow-hidden bg-black text-foreground relative">
        <SimpleSidebar user={user} onCollapsedChange={setSidebarCollapsed} />
        
        {/* Main Content Area - Shifted by Sidebar Width */}
        <div className={`${sidebarCollapsed ? "pl-20" : "pl-72"} h-full flex flex-col relative z-0 transition-all duration-300`}>
      ...
      {/* Mobile Layout */}
      <div className="md:hidden flex flex-col h-screen overflow-hidden bg-black text-foreground">
