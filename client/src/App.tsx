...
function AuthenticatedLayout() {
  ...
  usePushSubscription();
  // Keep the installed PWA from closing on the OS back gesture at the home screen.
  useExitGuard();
  ...
  return (
    <>
      ...
      {/* Mobile Layout */}
      <div className="r7-app-root md:hidden flex flex-col h-dvh overflow-hidden text-foreground">
        <main className="flex-1 overflow-y-auto overflow-x-hidden overscroll-x-none custom-scroll pb-2 relative z-0 safe-area-top">
          <RouteErrorBoundary>
          <Switch>
            <Route path="/" component={() => <Redirect to="/dashboard" />} />
            <Route path="/auth" component={() => (
